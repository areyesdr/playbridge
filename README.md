...
2. En PC: `music.youtube.com` con sesión → F12 → Red → filtra `/browse` →
   click derecho → *Copiar headers de solicitud*
3. Pegar → **Guardar y conectar** (queda respaldado en la DB)
